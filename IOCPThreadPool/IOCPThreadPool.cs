...
namespace Incubator.Threading
{
    /// <summary> 
    /// 提供对Win32中IOCompletionPort相关API的封装
    /// </summary>
    public class IOCPThreadPool : IDisposable
    {
        ...
        /// <summary>
        /// 增加IOCP线程池work item计数
        /// </summary>
        private int IncCurrentWorks()
        {
            return Interlocked.Increment(ref _currentWorks);
        }

        /// <summary>
        /// 减少IOCP线程池work item计数
        /// </summary>
        private int DecCurrentWorks()
        {
            return Interlocked.Decrement(ref _currentWorks);
        }
        #endregion
    }
}
