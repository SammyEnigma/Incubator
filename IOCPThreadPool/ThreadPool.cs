...
namespace Incubator.Threading
{
    public class SimpleThreadPool
    {
        ...
        static SimpleThreadPool() { Initialize(); }
        ...
        private static void Initialize()
        {
            ...
            _workerThreadNeeded = new Semaphore(0, 0);
                ...
                if (callback != null)
                {
                    ...
                    catch (Exception exc)
                    {
                        try
                        {
                            ...
                            if (handler != null) handler(typeof(IOCPThreadPool), new UnhandledExceptionEventArgs(exc, false));
                        }
                        catch { }
                    }
                    finally
